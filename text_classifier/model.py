...
class Text_Classifier(nn.Module):
    ...
    def __init__(self, embedding_matrix, le):
...
def preprocess_data(data):
    ...
    data["News"] = data["News"].apply(lambda x: clean_numbers(x))
    data["News"] = data["News"].apply(lambda x: replace_contractions(x))
    return data

def load_glove(word_index):
    EMBEDDING_FILE = 'C:/Users/Vusale/Desktop/Development/ML tasks/glove.840B.300d.txt'
...
if __name__ == "__main__":
    ...
    data['len'] = data['News'].apply(lambda s : len(s))
    ...
    for epoch in range(n_epochs):
        ...
        print('Epoch {}/{} /t loss={:.4f} /t val_loss={:.4f}  /t val_acc={:.4f}  /t time={:.2f}s'.format(
